package com.software.tongji.easygo.TravelPlanModule.RoutePlanning;
...
public class RoutePlanningActivity extends AppCompatActivity implements AMapNaviListener{
    ...
    public static Intent newIntent(Context packageContext, String tourId){
        Intent intent = new Intent(packageContext, RoutePlanningActivity.class);
