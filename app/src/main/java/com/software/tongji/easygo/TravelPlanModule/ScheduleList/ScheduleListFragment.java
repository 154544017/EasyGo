...
import com.software.tongji.easygo.DrawerModule.About.AboutActivity;
...
import com.software.tongji.easygo.DrawerModule.CheckList.CheckListActivity;
import com.software.tongji.easygo.TravelPlanModule.RoutePlanning.RoutePlanningActivity;
import com.software.tongji.easygo.TravelPlanModule.NewSchedule.NewScheduleActivity;
import com.software.tongji.easygo.DrawerModule.Tour.SaveTourActivity;
import com.software.tongji.easygo.DrawerModule.Tour.TourListActivity;
...
public class ScheduleListFragment extends Fragment implements ScheduleListView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        mLinePlanning.setOnClickListener(view14 -> {
            ...
            Intent intent = RoutePlanningActivity.newIntent(getContext(), mTourId);
